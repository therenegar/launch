 ...
 * File: DFETCH.C
 * Role: !DFETCH system-information display
 * Build/ownership: Canonical source; build copy is FETCHBLD.C.
 * Maintainer contract: Displays hardware/system facts in a compact dialog and can print the current report.
