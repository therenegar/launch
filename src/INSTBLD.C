 ...
 * File: INSTBLD.C
 * Role: Generated/build installer source
 * Build/ownership: Derived from INSTALL.C and compiled as INSTALL.EXE.
 * Maintainer contract: Do not let build-only transforms diverge from installer requirements.
