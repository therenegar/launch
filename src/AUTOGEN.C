/* AutoGen 1.9 - automatic Launch! menu generator for DOS.
...
static int write_menu(void)
{
  ...
  fputs("; Launch! 1.9 menu generated by AutoGen\n\n[Launcher]\n",f);
...
{
  puts("AutoGen 1.9 - an automatic menu generator for Launch!\n");
...
int main(int argc,char **argv)
{
  ...
  puts("AutoGen 1.9 - Launch! Program Scanner\n");
