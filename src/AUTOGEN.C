/* AutoGen 3.1 - automatic Launch! menu generator for DOS.
...
static void question_icon(void){colour_text(" ? ",0x1F);putchar(' ');}
...
static int write_menu(void)
{
  ...
  fputs("; Launch! 3.1 menu generated by AutoGen\n\n[Launcher]\n",f);
...
int main(int argc,char **argv)
{
  ...
  puts("AutoGen 3.1 - Launch! Program Scanner\n");
