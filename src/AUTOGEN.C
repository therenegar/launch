/* AutoGen 2.5 - automatic Launch! menu generator for DOS.
...
static int write_menu(void)
{
  ...
  fputs("; Launch! 2.5 menu generated by AutoGen\n\n[Launcher]\n",f);
...
{
  puts("AutoGen 2.5 - an automatic menu generator for Launch!\n");
...
int main(int argc,char **argv)
{
  ...
  puts("AutoGen 2.5 - Launch! Program Scanner\n");
