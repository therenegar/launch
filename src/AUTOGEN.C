/* AutoGen 1.8 - automatic Launch! menu generator for DOS.
...
static int write_menu(void)
{
  ...
  fputs("; Launch! 1.8 menu generated by AutoGen\n\n[Launcher]\n",f);
...
{
  puts("AutoGen 1.8 - an automatic menu generator for Launch!\n");
...
int main(int argc,char **argv)
{
  ...
  puts("AutoGen 1.8 - Launch! Program Scanner\n");
