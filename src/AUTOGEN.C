/* AutoGen 2.4 - automatic Launch! menu generator for DOS.
...
static int write_menu(void)
{
  ...
  fputs("; Launch! 2.4 menu generated by AutoGen\n\n[Launcher]\n",f);
...
{
  puts("AutoGen 2.4 - an automatic menu generator for Launch!\n");
...
int main(int argc,char **argv)
{
  ...
  puts("AutoGen 2.4 - Launch! Program Scanner\n");
