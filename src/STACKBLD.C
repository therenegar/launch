 ...
 * File: STACKBLD.C
 * Role: Build copy of !STACK
 * Build/ownership: Derived from STACK.C.
 * Maintainer contract: Keep synchronized with STACK.C; note its unusually tight near-data budget.
