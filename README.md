<img width="6771" height="613" alt="logo" src="https://github.com/user-attachments/assets/6c642f70-e2b9-4969-ae96-9bbe2be8e9ab" />
...
* `INSTALL.EXE` - [Launch! Installer](https://github.com/therenegar/launch/wiki/INSTALL.EXE)
...
* `!BOXES.EXE` - [Boxes](https://github.com/therenegar/launch/wiki/!BOXES.EXE)
* `!CAL.EXE` - [Calendar](https://github.com/therenegar/launch/wiki/!CAL.EXE)
* `!CALC.EXE` - [Calculator](https://github.com/therenegar/launch/wiki/!CALC.EXE)
* `!DRAW.EXE` - [Pixel Draw](https://github.com/therenegar/launch/wiki/!DRAW.EXE)
* `!NOTE.EXE` - [Note](https://github.com/therenegar/launch/wiki/!NOTE.EXE)
* `!POP.EXE` - [Pop](https://github.com/therenegar/launch/wiki/!POP.EXE)
* `!SOL.EXE` - [Solitaire](https://github.com/therenegar/launch/wiki/!SOL.EXE)
* `!STACK.EXE` - [Card Stack](https://github.com/therenegar/launch/wiki/!STACK.EXE)
* `!SYSINFO.EXE` - [System Information](https://github.com/therenegar/launch/wiki/!SYSINFO.EXE)
* `!TODOS.EXE` - [To-dos](https://github.com/therenegar/launch/wiki/!TODOS.EXE)

## Tools

* `SHORTCUT.COM` - [keyboard shortcut tool](https://github.com/therenegar/launch/wiki/SHORTCUT.COM)
* `AUTOGEN.EXE` - [an automatic menu generator](https://github.com/therenegar/launch/wiki/AUTOGEN.EXE)
